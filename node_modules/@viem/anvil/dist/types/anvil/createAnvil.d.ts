...
export type Anvil = {
    ...
    on(event: "exit", listener: (code?: number, signal?: NodeJS.Signals) => void): () => void;
    /**
...
type Hardfork = "Frontier" | "Homestead" | "Dao" | "Tangerine" | "SpuriousDragon" | "Byzantium" | "Constantinople" | "Petersburg" | "Istanbul" | "Muirglacier" | "Berlin" | "London" | "ArrowGlacier" | "GrayGlacier" | "Paris" | "Shanghai" | "Latest";
 ...
 */
export declare function createAnvil(options?: CreateAnvilOptions): Anvil;
export {};
//# sourceMappingURL=createAnvil.d.ts.map