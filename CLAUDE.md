...
```
ENV_FILE=.env.prod npx playwright test --config=web3tv/playwright.config.ts web3tv/tests/production/setup.spec.ts --project=prodSmoke
```
...
- `prodSmoke` — smoke tests for prod, Chromium 1920×1080
